...
NDiplomacy = {
	...
	BASE_IMPROVE_RELATION_COST = 150,                -- Political power cost to initiate relation improvement
	...
	VERY_GOOD_OPINION = 125,							-- Threshold for a country that has a very good opinion of you.
	VERY_BAD_OPINION = -125,							-- Threshold for a country that has a very bad opinion of you.
	...
	TENSION_TIME_SCALE_START_DATE = "1300.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
	...
	BASE_CONDITIONAL_PEACE_WARESCORE_RATIO = 0, 	-- Warscore ratio needed for the losing side to able to surrender.
	BASE_CONDITIONAL_PEACE_MONTHS = 0,				-- War length must be before a surrender i possible.
	...
	FRONT_IS_DANGEROUS = -10,						-- AI should be unwilling to enter accept a call to war if front is too dangerous.
...
NCountry = {
	...
	PROVINCE_SCORE_MULTIPLIER = 1.0,				-- Based on number of controlled provinces.
	...
	MAJOR_MIN_FACTORIES = 4,						-- need at least these many factories to become a major
	...
	MAX_INTELLIGENCE_CONVOY_DATA_DEVIATION = 0.4,	-- Max deviation in estimating enemy industry amount ( 0.0 - 1.0 )
	MAX_INTELLIGENCE_MANPOWER_DATA_DEVIATION = 0.3,	-- Max deviation in estimating enemy convoys amount ( 0.0 - 1.0 )
	MAX_INTELLIGENCE_FIELDED_MANPOWER_DATA_DEVIATION = 0.4,	-- Max deviation in estimating enemy total manpower amount ( 0.0 - 1.0 )
	MAX_INTELLIGENCE_INDUSTRY_DATA_DEVIATION = 0.35, -- Max deviation in estimating enemy fielded manpower amount ( 0.0 - 1.0 )
	...
	STATE_OCCUPATION_COST_MULTIPLIER = 0.00,		-- Multiplier for state value to PP cost for occupation
	...
	ATTACHE_XP_SHARE = 0.25,							-- Country received xp from attaches
...
NResistance = {
	...
	COMPLIANCE_GROWTH_BASE = 50.00, -- base compliance grow
	COMPLIANCE_GROWTH_MIN = 40.0, -- min compliance grow
...
NBuildings = {
	...
	MAX_BUILDING_LEVELS = 20,			-- Max levels a building can have.
...
NMilitary = {
	...
	CORPS_COMMANDER_DIVISIONS_CAP = 1,			-- how many divisions a corps commander is limited to. 0 = inf, < 0 = blocked
	...
	FIELD_MARSHAL_ARMIES_CAP = 1,				-- how many armies a field marshall is limited to. 0 = inf, < 0 = blocked
	...
	LAND_COMBAT_COLLATERAL_FORT_FACTOR = 0.005,		   -- Factor to scale collateral damage to infra and forts with.
	...
	UNIT_DIGIN_CAP = 2,                           -- how "deep" you can dig you can dig in until hitting max bonus
...
NAI = {
	...
	EXTRA_NAVY_INTEL_FOR_CONVOY_RAIDING = 1.0,                    -- extra decryption for convoy raiding
